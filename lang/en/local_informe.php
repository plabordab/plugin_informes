...
$string['pluginname'] = 'Informe de Tiempo';
...
$string['check_nombre'] = 'Nombre del alumno';
$string['check_apellido'] = 'Apellidos del alumno';
$string['check_curso'] = 'Curso del alumno';
$string['check_grupo'] = 'Grupo Formativo del curso';
